...
@frappe.whitelist()
def show_weighted_discounts(item_code, discount_price, discount_per_qty, as_of_date, min_qty=2, max_qty=None):
	...
	max_qty = discount_per_qty * 2  # chat with shelby on March 29th
